...
export default function HomeSection() {
  return (
    <div
      id="home"
      className="relative overflow-hidden min-h-screen flex items-center justify-center px-4 sm:px-8 md:px-10 pt-24"
    >
      {/* Background Image */}
      <img
      ...
      <motion.div
        ...
        className="relative w-full max-w-4xl bg-white/85 backdrop-blur-md 
        p-6 sm:p-8 md:p-12 rounded-3xl shadow-2xl text-center 
      ...
      >
        ...
        <motion.p
          ...
          leading-relaxed text-gray-700 mb-6 sm:mb-10"
        >
        ...
        >
          <button
            className="bg-gradient-to-r from-purple-600 via-orange-400 to-white-500 
