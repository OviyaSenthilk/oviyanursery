...
//       <div className="absolute inset-0 bg-fuchsia-200"></div>
  ...
  return (
    <section
      ...
      className="relative w-full min-h-[100svh] flex items-center justify-center overflow-hidden
                 px-4 sm:px-8 md:px-10 pt-28"
    >
      {/* Background wrapper that always matches section height */}
      <div className="absolute inset-0 -z-10">
        ...
        />
        <div className="absolute inset-0 bg-fuchsia-100" />
      </div>
